        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="pr-4">
              ...
              {getCurrentPageItems().map((item, index) => (
                <div key={item.id} className="transition-all duration-500">
                  <div className="flex mb-4">
                    <div className="text-[120px] font-bold text-[#1e2a4a] leading-none mr-8">
                      <div className="flex items-start">
                        <span className="text-[80px] mt-6">#</span>
                    ...
                    <div className="flex flex-col">
                      <div className="space-y-1">
                        <h3 className="text-2xl font-bold text-[#1e2a4a]">
                          {item.title}
                        </h3>
                        <p className="text-xl text-[#1e2a4a]">
                          {item.description}
                        </p>
                      </div>
                      <div className="mt-4">
                        <div className="h-[40px] relative">
                          <img
                            ...
                            className="object-contain h-[40px] w-auto max-h-[40px]"
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  {index === 0 && (
                    <div className="w-full h-0.5 bg-white my-6"></div>
                  )}
                </div>
              ))}
            </div>
            <div className="flex space-x-2 mt-8">
              <button
                onClick={prevSlide}
                className="bg-[#1e2a4a] text-white p-3 hover:bg-[#2a3a5a] transition-colors"
          ...
          <div className="flex justify-center items-center">
            <video
              ...
              muted
              playsInline
              className="w-[150%] max-w-[90%] lg:max-w-[200%]"
            >
