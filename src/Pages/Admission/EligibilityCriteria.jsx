  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="p-8">
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-100 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <h4 className="text-lg font-semibold flex items-center text-gray-900">
                <span className="bg-gradient-to-br from-cusYellow to-yellow-400 p-2 rounded-full mr-3 text-white">
              ...
              <h4 className="text-lg font-semibold flex items-center mt-8 text-gray-900">
                <span className="bg-gradient-to-br from-cusYellow to-yellow-400 p-2 rounded-full mr-3 text-white">
              ...
              <ul className="space-y-3">
                {course.benefits.slice(0, 5).map((benefit, idx) => (
                  <li key={idx} className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-cusYellow flex-shrink-0 mt-0.5" />
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {course.positions.slice(0, 6).map((position, idx) => (
                      <div
                        key={idx}
                        className="bg-gradient-to-br from-gray-50 to-gray-100 p-3 rounded-lg text-sm text-gray-700 shadow-sm border border-gray-100"
                      >
                        {position}
                      </div>
                    ))}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {course.careerPaths.private
                      ...
                      .map((company, idx) => (
                        <span
                          key={idx}
                          className="bg-gradient-to-br from-cusYellow/10 to-yellow-400/10 px-4 py-2 rounded-full text-sm text-gray-700 shadow-sm"
                        >
                          {company}
                        </span>
                      ))}
