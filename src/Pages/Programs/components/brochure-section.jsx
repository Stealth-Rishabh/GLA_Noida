...
import brochurePdf from "@/assets/programs/General Brochure_Single 2025-26.pdf";
              ...
              >
                <a href={brochurePdf} target="_blank" rel="noopener noreferrer">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="gap-2 group bg-cusSecondary cursor-pointer text-cusText hover:bg-cusSecondary/80 transition-all duration-300 hover:pl-6 hover:pr-10 flex items-center px-4 py-2 rounded-md"
                  >
                    Download Now
                    <motion.span
                      whileHover={{ x: 5 }}
